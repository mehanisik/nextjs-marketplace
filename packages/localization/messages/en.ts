export default {
  ...
  home: {
    ...
    description:
      "Next Marketplace is a platform for buying and selling products.",
  },
  hero: {
    title: "Your Ultimate Marketplace Platform",
    description:
      "Buy, sell, and discover unique items in a secure and user-friendly environment. Join our growing community today.",
    buttons: {
  ...
  features: {
    ...
    description:
      "Experience the best marketplace platform with features designed for both buyers and sellers.",
    items: {
      easyBuyingSelling: {
      ...
      secureTransactions: {
        ...
        description:
          "Protected payments and verified sellers for peace of mind.",
      },
      growingCommunity: {
  ...
  testimonials: {
    ...
    items: {
      ...
      testimonial3: {
        ...
        authorCompany: "Digital Goods Co",
      },
    },
  },
  cta: {
    ...
    description:
      "Join thousands of creators and buyers on our platform today. Start your marketplace journey now.",
    primaryButton: "Get Started Now",
    secondaryButton: "Learn More",
  },
  footer: {
    copyright: "© {year} Next Marketplace. All rights reserved.",
    sections: {
      product: {
        title: "Product",
        links: {
